...
- Create Angular project with ng: `ng new cdbcalculatorapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`cdbcalculatorapp.client.esproj`).
